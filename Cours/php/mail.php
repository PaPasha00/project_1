...
$mail->addAddress('marketing_nikolov@mail.ru'); 
$mail->addAddress('annushka_project@mail.ru');// Кому будет уходить письмо 
...
$mail->Body    = '' .$name . ' оставил заявку! <br>'  . "Телефон <br>" .$phone . "<br> Сообщение: " .$option;
$mail->AltBody = '';
